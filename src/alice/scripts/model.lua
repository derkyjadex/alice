...
ModelPath.prototype.set_point = wrap_command(commands.model_path_set_point)
ModelPath.prototype.add_point = wrap_command(commands.model_path_add_point)
ModelPath.prototype.remove_point = wrap_command(commands.model_path_remove_point)
...
Model.prototype.load = wrap_command(commands.model_load)
Model.prototype.save = wrap_command(commands.model_save)
...
Model.prototype.add_path = wrap_command(commands.model_add_path)
Model.prototype.remove_path = wrap_command(commands.model_remove_path)
